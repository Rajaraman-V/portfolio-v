...
const socials = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/raja-raman-a6870b2b2/",
    icon: (
  ...
  {
    label: "GitHub",
    href: "https://github.com/Rajaraman-V",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/_.r_a_j_a_r_a_m_a_n._",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            <div className="flex flex-col items-center p-6 rounded-xl bg-card border border-border">
              ...
              <p className="text-sm text-muted-foreground">rajaraman@email.com</p>
            </div>
            <div className="flex flex-col items-center p-6 rounded-xl bg-card border border-border">
              <Phone className="text-primary mb-3" size={24} />
              <p className="text-sm text-muted-foreground">+91 72004 28758</p>
            </div>
            <div className="flex flex-col items-center p-6 rounded-xl bg-card border border-border">
          ...
          >
            <a
              href="/pubilc/Resume.pdf"
              download
              className="inline-flex items-center gap-2 px-8 py-3 bg-primary text-primary-foreground rounded-lg font-display font-medium hover:bg-primary/90 transition-colors"
            >
              <Download size={18} />
              Download Resume
            </a>
